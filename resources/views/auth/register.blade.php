...
@section('content')
    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
        ...
        <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                {!!Form::select('type',['Administrativo'=>'Administrativo','Coordinador'=>'Coordinador','Grupo'=>'Grupo','Profesor'=>'Profesor'],null,['class'=>'form-control select-category required','placeholder'=>'Elige un tipo de usuario'])!!}
